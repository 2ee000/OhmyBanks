...
function Signup() {
      ...
      return(
        <Signup>
          <SignupWrapper>
            ...
            <SignupButton onClick={() => {setStep(1); setSignupWrapperGap('80px')}}>회원가입</SignupButton>
            <AnotherSignup>
      ...
      return(
        <Signup>
          <SignupWrapper>
            ...
            <Certification>
              <SignupWhiteButtons>
                <SignupWhiteButton onClick={() => {setStep(2); setSignupWrapperGap('80px')}}>휴대폰 인증<Arrow/></SignupWhiteButton>
          ...
          <SignupWrapper>
            ...
            <Information>
              ...
              <InformationWrapper>
                ...
                <InformationContents>
                  <InformationContent placeholder='아이디' type='text'/>
                  <CheckBoxs>
                    <CheckBoxWrapper>
              ...
              <InformationWrapper>
                ...
                <InformationContents>
                  <InformationContent placeholder='비밀번호' type='password'/>
                  <CheckBoxs>
                    <CheckBoxWrapper>
                      <DefaultCheckBox type='checkbox'/>
                ...
                <InformationContents>
                  <InformationContent placeholder='비밀번호 확인' type='password'/>
                  <CheckBoxs>
                    <CheckBoxWrapper>
                      <DefaultCheckBox type='checkbox'/>
              ...
              <InformationWrapper>
                ...
                <InformationContents>
                  <InformationContent placeholder='이메일' type='email'/>
                  <CheckBoxs>
                    <CheckBoxWrapper>
                      <DefaultCheckBox type='checkbox'/>
  ...
  const SignupScroll = styled(Signup)`
    height: fit-content;
    position: fixed;
    top: 0;
    right: 0;
